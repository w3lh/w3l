...
Thanks to Keres on the PvPGN forums for releasing fixes and updates, and to all who helped test and debug this release there. Thanks to Google Chrome developers for DEP disabling method. Thanks to Phoenicks on the Bored Aussie forums for ad blocking patch and 1.25b game.dll offset. Thanks to cen1 from Github for winapi base address detection.
